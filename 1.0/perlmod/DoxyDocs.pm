    ...
    },
    {
      ...
      detailed => {
        doc => [
          ...
          {
            type => 'preformatted',
            content => 'char solve_square_equation(int a, int b, int c, double* x1, double* x2){
    if (c == 0)
    {
    ...
    },
    {
      ...
      detailed => {
        doc => [
          ...
          {
            type => 'text',
            content => 'This is second head function in this program, it\'s getting coefficients from printed equation by processing every symbol of it. At the end it print coefficients of this equation in a, b and c variables. '
          },
          {
            params => [
              {
          ...
          {
            type => 'preformatted',
            content => 'char print_equation(int* a, int* b, int* c){
            ...
            params => [
              ...
              },
              {
                ...
                doc => [
                  ...
                  {
                    type => 'text',
                    content => 'it\'s string variable which contains answer of user about want he to write equation by yourself or just coefficients '
                  }
                ]
              },
              {
                ...
                doc => [
                  ...
                  {
                    type => 'text',
                    content => 'it\'s vector of chars in input of user\'s equations '
                  }
                ]
              },
              {
                ...
                doc => [
                  ...
                  {
                    type => 'text',
                    content => 'it\'s temperary char variable which used in inputing user_equation'
                  }
                ]
              }
            ]
